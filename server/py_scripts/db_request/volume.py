...
async def get_all_books() -> List[Record]:
    """
    Все книги: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
    SELECT v.id, v.release_year, v.page_count, v.name_en, v.name_ru, vn.full_name_en, vn.full_name_ru, v.publisher_id, v.series_id
...
async def get_books_by_publisher(publisher_id: str) -> List[Record]:
    """
    Все книги по ID издателя: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
    SELECT v.id, v.release_year, v.page_count, v.name_en, v.name_ru, vn.full_name_en, vn.full_name_ru, v.publisher_id, v.series_id
...
async def get_books_by_publisher_without_series(publisher_id: str) -> List[Record]:
    """
    Все книги по ID издателя без серий: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
    SELECT v.id, v.release_year, v.page_count, v.name_en, v.name_ru, vn.full_name_en, vn.full_name_ru, v.publisher_id, v.series_id
...
async def get_books_by_series(series_id: str) -> List[Record]:
    """
    Все книги по ID серии: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
    SELECT v.id, v.release_year, v.page_count, v.name_en, v.name_ru, vn.full_name_en, vn.full_name_ru, v.publisher_id, v.series_id
...
async def get_book_by_id(book_id: str) -> Optional[Record]:
    """
    Книга по ID: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
    SELECT v.id, v.release_year, v.page_count, v.name_en, v.name_ru, vn.full_name_en, vn.full_name_ru, v.publisher_id, v.series_id
...
async def get_all_books_in_series(series_id: str) -> List[Record]:
    """
    Все книги в серии: id, release_year, page_count, name_en, name_ru, full_name_en и full_name_ru, publisher_id, series_id
    """
    conn = await get_db_connection()
    query = """
